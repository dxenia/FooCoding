...
// Connection to the database setup
...
// Readline setup, Node.js 'process' module
const rl = readline.createInterface({
  input: process.stdin,
  output: process.stdout,
});

// Implementation of prepared statements, app's main structure
rl.question('Select one of the following options (To do so, press either 1, 2, 3, 4, 5, and select enter):\n1. Select a country to know the capital.\n2. Obtain a list of all the languages spoken in a selected region.\n3. Find the number of cities in which a selected language is spoken.\n4. List all the continents with the number of languages spoken in each continent.\n5. For the country given as input, find out whether there are any countries that have the same official language and are located in the same continent.',
  (option) => {
